...
function counterToggle() {
  var cK = document.getElementById("counterKalender");
  var cB = document.getElementById("counterButton");
  if (cK.classList.contains("hidden")) {
    cK.classList.remove("hidden");
    cB.classList.add("toggleON");
  } else {
    cK.classList.add("hidden");
    cB.classList.remove("toggleON");
  }
}
